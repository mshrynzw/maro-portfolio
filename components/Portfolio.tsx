      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <Link
              href="https://youtube.com/shorts/WwQJ8RWbWqA?feature=share"
              legacyBehavior
            >
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/rust_synth"
                legacyBehavior
              >
          ...
          <div>
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/nextjs-firebase-groupware"
                legacyBehavior
              >
                <a className="badge" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon
              ...
              <div className="primary">
                ID: test0001@gmail.com / PW :Te2t000!
              </div>
              <div className="primary">開発中</div>
            </div>
          </div>
          ...
          <div>
            ...
            <Link
              href="http://ec2-18-179-37-90.ap-northeast-1.compute.amazonaws.com/"
              legacyBehavior
            >
              <a target="_blank" rel="noopener noreferrer">
                <Image
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/nuxt-realtime-chat"
                legacyBehavior
              >
                <a className="badge" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon
          ...
          <div>
            <h3 className="tertiary-title">Chat</h3>
            <Link
              href="http://ec2-54-168-23-57.ap-northeast-1.compute.amazonaws.com:3000/messages"
              legacyBehavior
            >
              <a target="_blank" rel="noopener noreferrer">
                <Image
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/rails_realtime_chat"
                legacyBehavior
              >
                <a className="badge" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon
          ...
          <div>
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/angular-gsap-hp"
                legacyBehavior
              >
                <a className="badge" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon
          ...
          <div>
            ...
            <Link
              href="https://laravel-todo-old-forest-9962.fly.dev/"
              legacyBehavior
            >
              <a target="_blank" rel="noopener noreferrer">
                <Image
            ...
            <div className="mt-6 mb-8 flex w-full flex-wrap justify-center gap-3 lg:w-auto lg:justify-start">
              <Link
                href="https://github.com/mshrynzw/laravel_todo"
                legacyBehavior
              >
                <a className="badge" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon
