    ...
    <section id="home" className="container mx-auto flex w-full items-center justify-between px-8 md:px-14 lg:px-24">
      <div className="flex flex-wrap md:flex-nowrap">
        <div className="mx-auto max-w-xl rounded-md border border-gray-200/30 bg-gray-800/5 p-4 shadow-lg backdrop-blur-lg dark:bg-gray-800/30 md:my-36 lg:ml-20">
          ...
          <Link href="/#portfolio">
            <button className="mx-auto mt-4 flex h-12 items-center rounded-lg bg-blue-600 px-6 py-4 font-bold text-white shadow-2xl transition-all duration-300 space-x-3 hover:bg-blue-500">
